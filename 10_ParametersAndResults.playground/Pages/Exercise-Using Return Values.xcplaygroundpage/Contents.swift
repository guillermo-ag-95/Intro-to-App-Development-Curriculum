...
let numberOfImpossibleThings = impossibleBeliefsCount(pigsFlying: 2, frogsBecomingPrinces: 4, multipleLightningStrikes: 3)
let sentence = impossibleThingsPhrase(numberOfImpossibleThings, "dinner")
