 ...
 */
var marmotVotes: Int = 0
var salamanderVotes: Int = 0
var neitherVotes: Int = 0

for vote in mascotVotes {
    switch vote {
    case SchoolMascotOption.marmot:
        marmotVotes += 1
    case SchoolMascotOption.salamander:
        salamanderVotes += 1
    case SchoolMascotOption.neither:
        neitherVotes += 1
    }
}
