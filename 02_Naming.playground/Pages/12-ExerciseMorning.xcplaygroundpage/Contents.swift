...
let cleanMyself = 10
let getDressed = 5
let prepareBreakfast = 5
let eatBreakfast = 10
let checkEverythingIsRight = 3
// Add more here...
...
let totalTime = wakeUp + cleanMyself + getDressed + prepareBreakfast + eatBreakfast + checkEverythingIsRight
...
let thingsIHaveToDo = wakeUp + cleanMyself + getDressed + prepareBreakfast + checkEverythingIsRight
let thingsILikeToDo = eatBreakfast
